...
Now, the matching works again. because the <span class="bottom-border red">first alternative</span> was never even evaluated--the <span class="bottom-border green">second one</span> is the only path the engine follows, and never needs to backtrack to find a match.
<br>
<br>
